...
ActiveRecord::Schema.define(version: 2020_04_02_230713) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.decimal "price"
    t.integer "guntype_id", null: false
    t.integer "quality_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["guntype_id"], name: "index_products_on_guntype_id"
  ...
  add_foreign_key "products", "guntypes"
